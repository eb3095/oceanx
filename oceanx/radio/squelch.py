"""Adaptive squelch gate for marine playback and transcription."""
...
from oceanx.config import AIRBAND_AUDIO_RATE
...
class SquelchGate:
    ...
    def gate_audio(
        self, audio: np.ndarray, sample_rate: int = AIRBAND_AUDIO_RATE, now: float = 0.0
